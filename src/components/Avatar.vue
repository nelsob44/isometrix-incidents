        ...
        <g transform="translate(825.000000, 1100.000000)">
          ...
          >
            ...
            <g id="Clothing/Hoodie" transform="translate(0.000000, 170.000000)">
              ...
              <mask id="react-mask-588" fill="white">
                <use xlink:href="#react-path-587"></use>
              </mask>
              <use
                id="Hoodie"
                fill="#B7C1DB"
                fill-rule="evenodd"
                xlink:href="#react-path-587"
              ></use>
              <g
                id="Color/Palette/Gray-01"
                mask="url(#react-mask-588)"
                fill-rule="evenodd"
                fill="#3C4F5C"
              >
            ...
            >
              <g id="Mouth/Smile" transform="translate(2.000000, 52.000000)">
                ...
                <mask id="react-mask-716" fill="white">
                  <use xlink:href="#react-path-715"></use>
                </mask>
                <use
                  id="Mouth"
                  ...
                  fill="#000000"
                  fill-rule="evenodd"
                  xlink:href="#react-path-715"
                ></use>
                <rect
                  id="Teeth"
                  fill="#FFFFFF"
                  fill-rule="evenodd"
                  mask="url(#react-mask-716)"
                  x="39"
                  y="2"
                  width="31"
                  height="16"
            ...
            <g id="Top" stroke-width="1" fill-rule="evenodd">
              ...
              <mask id="react-mask-379" fill="white">
                <use xlink:href="#react-path-381"></use>
              </mask>
              <g id="Mask"></g>
              <g id="Top/Short-Hair/Short-Waved" mask="url(#react-mask-379)">
                <g transform="translate(-1.000000, 0.000000)">
                  ...
                  >
                    ...
                    <use
                      ...
                      fill="#331B0C"
                      fill-rule="evenodd"
                      xlink:href="#react-path-484"
                    ></use>
                    <g
                      id="Color/Hair/Brown"
                      mask="url(#react-mask-483)"
                      fill="#4A312C"
                    >
                  ...
                  <mask id="react-mask-378" fill="white">
                    <use xlink:href="#react-path-380"></use>
                  </mask>
                  <use
                    id="Short-Hair"
                    stroke="none"
